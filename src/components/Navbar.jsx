...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      ...
      <ul
        className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-0 right-0 mx-auto w-max md:w-auto md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent transition-all md:transition-none z-50 ${
